      ...
      user_details: u?.user_details
        ? {
            name: u.user_details?.name
              ? String(u.user_details.name)
              : undefined,
            country: u.user_details?.country
              ? String(u.user_details.country)
              : undefined,
            city: u.user_details?.city
              ? String(u.user_details.city)
              : undefined,
            zip: u.user_details?.zip ? String(u.user_details.zip) : undefined,
            address: u.user_details?.address
              ? String(u.user_details.address)
              : undefined,
            avatar: u.user_details?.avatar
              ? String(u.user_details.avatar)
              : undefined,
          }
        : undefined,
    }))
